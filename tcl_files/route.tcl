...
# Routing Setup & Technology Rules
set_app_options -name route.global.force_rerun_after_global_route_opt -value true
set_app_options -name route.global.timing_driven -value true
set_app_options -name route.track.timing_driven -value true
set_app_options -name route.detail.timing_driven -value true

# TS22 specific routing options 
set_app_options -name route.common.connect_within_pins_by_layer_name -value {{M1 via_standard_cell_pins} {M2 off} {M3 off} {M4 off} {M5 off} {M6 off} {M7 off} {M8 off} }
...
# Optimize timing, area, and fix routing DRCs
route_opt
